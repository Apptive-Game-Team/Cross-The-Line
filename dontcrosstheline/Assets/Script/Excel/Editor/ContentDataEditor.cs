...
[CustomEditor(typeof(ContentDBSO))]
    ...
    private void OnEnable()
    {
        ...
        datas = new ReorderableList(serializedObject, datasProperty, true, true, false, false)
        {
            ...
            drawElementCallback = (rect, index, isActive, isFocused) =>
            {
                ...
                var contentSO = (ContentDataSO)element.objectReferenceValue;
                string titleRaw = $"{contentSO.id}. {contentSO.message}";
                string title = titleRaw.Length > 40 ? titleRaw.Substring(0, 40) + "..." : titleRaw;
                string foldoutKey = $"Content_{index}_{contentSO.name}";
                ...
                if (isFoldoutExpandedsByTitle[foldoutKey]) {
                    ...
                    if (contentSO.image != null)
                    {
                        Rect imageRect = new Rect(rect.x + padding, y, imageSize, imageSize);
                        EditorGUI.DrawPreviewTexture(imageRect, contentSO.image.texture);
                    }
                    ...
                    EditorGUI.TextField(wField, GUIContent.none, contentSO.w.ToString());
                    ...
                    EditorGUI.TextField(msField, GUIContent.none, contentSO.minStage.ToString());
                    ...
                    EditorGUI.TextField(statusField, GUIContent.none, $"(Bad:{contentSO.minStatus.Bad}, Secret:{contentSO.minStatus.Secret})");
